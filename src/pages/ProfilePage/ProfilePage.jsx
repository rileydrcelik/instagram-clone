import { Container, Flex, Skeleton, SkeletonCircle, VStack, Text, Link } from '@chakra-ui/react';
...
const ProfilePage = () => {
  ...
  return <Container maxW="container.lg" py={5}>
    ...
    <Flex px={{base:2,sm:4}} maxW={"full"} mx={"auto"} borderTop={"1px solid"} bordercolor={"white.Alpha.300"} direction={"column"}>
